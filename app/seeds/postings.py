...
def seed_postings():
    ...
    post_three = Posting(user_id=2, address='3655 Lawton St', city='San Francisco', state='CA', zipcode=94122 , name='Free wood', caption='Tree fell down in our front yard. Come and chop some wood, if you need it!', icon='Option 3 - Supplies')
